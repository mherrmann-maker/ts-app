...
`)+`
`+m);const x=y+p+o,M=y+m+a,w=Od(i,i.VERTEX_SHADER,x),A=Od(i,i.FRAGMENT_SHADER,M);i.attachShader(g,w),i.attachShader(g,A),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function S(E){if(s.debug.checkShaderErrors){const N=i.getProgramInfoLog(g).trim(),z=i.getShaderInfoLog(w).trim(),X=i.getShaderInfoLog(A).trim();let j=!0,V=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(j=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,w,A);else{const Y=Fd(i,w,"vertex"),W=Fd(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
}`;function CS(s,e,t){let n=new tf;const i=new Te,r=new Te,o=new dt,a=new bS({depthPacking:a0}),l=new AS,c={},u=t.maxTextureSize,h={[ar]:On,[On]:ar,[Mi]:Mi},f=new Sn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:wS,fragmentShader:RS}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const _=new ln;_.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new Ft(_,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=lm;let m=this.type;this.render=function(A,S,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;const I=s.getRenderTarget(),v=s.getActiveCubeFace(),E=s.getActiveMipmapLevel(),N=s.state;N.setBlending(rr),N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const z=m!==ji&&this.type===ji,X=m===ji&&this.type!==ji;for(let j=0,V=A.length;j<V;j++){const Y=A[j],W=Y.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;i.copy(W.mapSize);const se=W.getFrameExtents();if(i.multiply(se),r.copy(W.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(r.x=Math.floor(u/se.x),i.x=r.x*se.x,W.mapSize.x=r.x),i.y>u&&(r.y=Math.floor(u/se.y),i.y=r.y*se.y,W.mapSize.y=r.y)),W.map===null||z===!0||X===!0){const ae=this.type!==ji?{minFilter:In,magFilter:In}:{};W.map!==null&&W.map.dispose(),W.map=new bi(i.x,i.y,ae),W.map.texture.name=Y.name+".shadowMap",W.camera.updateProjectionMatrix()}s.setRenderTarget(W.map),s.clear();const L=W.getViewportCount();for(let ae=0;ae<L;ae++){const ke=W.getViewport(ae);o.set(r.x*ke.x,r.y*ke.y,r.x*ke.z,r.y*ke.w),N.viewport(o),W.updateMatrices(Y,ae),n=W.getFrustum(),M(S,R,W.camera,Y,this.type)}W.isPointLightShadow!==!0&&this.type===ji&&y(W,R),W.needsUpdate=!1}m=this.type,p.needsUpdate=!1,s.setRenderTarget(I,v,E)};function y(A,S){const R=e.update(g);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new bi(i.x,i.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,s.setRenderTarget(A.mapPass),s.clear(),s.renderBufferDirect(S,null,R,f,g,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,s.setRenderTarget(A.map),s.clear(),s.renderBufferDirect(S,null,R,d,g,null)}function x(A,S,R,I){let v=null;const E=R.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(E!==void 0)v=E;else if(v=R.isPointLight===!0?l:a,s.localClippingEnabled&&S.clipShadows===!0&&Array.isArray(S.clippingPlanes)&&S.clippingPlanes.length!==0||S.displacementMap&&S.displacementScale!==0||S.alphaMap&&S.alphaTest>0||S.map&&S.alphaTest>0){const N=v.uuid,z=S.uuid;let X=c[N];X===void 0&&(X={},c[N]=X);let j=X[z];j===void 0&&(j=v.clone(),X[z]=j,S.addEventListener("dispose",w)),v=j}if(v.visible=S.visible,v.wireframe=S.wireframe,I===ji?v.side=S.shadowSide!==null?S.shadowSide:S.side:v.side=S.shadowSide!==null?S.shadowSide:h[S.side],v.alphaMap=S.alphaMap,v.alphaTest=S.alphaTest,v.map=S.map,v.clipShadows=S.clipShadows,v.clippingPlanes=S.clippingPlanes,v.clipIntersection=S.clipIntersection,v.displacementMap=S.displacementMap,v.displacementScale=S.displacementScale,v.displacementBias=S.displacementBias,v.wireframeLinewidth=S.wireframeLinewidth,v.linewidth=S.linewidth,R.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const N=s.properties.get(v);N.light=R}return v}function M(A,S,R,I,v){if(A.visible===!1)return;if(A.layers.test(S.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&v===ji)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,A.matrixWorld);const z=e.update(A),X=A.material;if(Array.isArray(X)){const j=z.groups;for(let V=0,Y=j.length;V<Y;V++){const W=j[V],se=X[W.materialIndex];if(se&&se.visible){const L=x(A,se,I,v);A.onBeforeShadow(s,A,S,R,z,L,W),s.renderBufferDirect(R,null,z,L,A,W),A.onAfterShadow(s,A,S,R,z,L,W)}}}else if(X.visible){const j=x(A,X,I,v);A.onBeforeShadow(s,A,S,R,z,j,null),s.renderBufferDirect(R,null,z,j,A,null),A.onAfterShadow(s,A,S,R,z,j,null)}}const N=A.children;for(let z=0,X=N.length;z<X;z++)M(N[z],S,R,I,v)}function w(A){A.target.removeEventListener("dispose",w);for(const R in c){const I=c[R],v=A.target.uuid;v in I&&(I[v].dispose(),delete I[v])}}}const PS={[Lu]:Du,[Iu]:Ou,[Nu]:Fu,[oo]:Uu,[Du]:Lu,[Ou]:Iu,[Fu]:Nu,[Uu]:oo};function LS(s){function e(){let U=!1;const ee=new dt;let K=null;const J=new dt(0,0,0,0);return{setMask:function(le){K!==le&&!U&&(s.colorMask(le,le,le,le),K=le)},setLocked:function(le){U=le},setClear:function(le,ce,Ke,Mt,Ct){Ct===!0&&(le*=Mt,ce*=Mt,Ke*=Mt),ee.set(le,ce,Ke,Mt),J.equals(ee)===!1&&(s.clearColor(le,ce,Ke,Mt),J.copy(ee))},reset:function(){U=!1,K=null,J.set(-1,0,0,0)}}}function t(){let U=!1,ee=!1,K=null,J=null,le=null;return{setReversed:function(ce){ee=ce},setTest:function(ce){ce?fe(s.DEPTH_TEST):oe(s.DEPTH_TEST)},setMask:function(ce){K!==ce&&!U&&(s.depthMask(ce),K=ce)},setFunc:function(ce){if(ee&&(ce=PS[ce]),J!==ce){switch(ce){case Lu:s.depthFunc(s.NEVER);break;case Du:s.depthFunc(s.ALWAYS);break;case Iu:s.depthFunc(s.LESS);break;case oo:s.depthFunc(s.LEQUAL);break;case Nu:s.depthFunc(s.EQUAL);break;case Uu:s.depthFunc(s.GEQUAL);break;case Ou:s.depthFunc(s.GREATER);break;case Fu:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}J=ce}},setLocked:function(ce){U=ce},setClear:function(ce){le!==ce&&(s.clearDepth(ce),le=ce)},reset:function(){U=!1,K=null,J=null,le=null}}}function n(){let U=!1,ee=null,K=null,J=null,le=null,ce=null,Ke=null,Mt=null,Ct=null;return{setTest:function(rt){U||(rt?fe(s.STENCIL_TEST):oe(s.STENCIL_TEST))},setMask:function(rt){ee!==rt&&!U&&(s.stencilMask(rt),ee=rt)},setFunc:function(rt,Re,Ee){(K!==rt||J!==Re||le!==Ee)&&(s.stencilFunc(rt,Re,Ee),K=rt,J=Re,le=Ee)},setOp:function(rt,Re,Ee){(ce!==rt||Ke!==Re||Mt!==Ee)&&(s.stencilOp(rt,Re,Ee),ce=rt,Ke=Re,Mt=Ee)},setLocked:function(rt){U=rt},setClear:function(rt){Ct!==rt&&(s.clearStencil(rt),Ct=rt)},reset:function(){U=!1,ee=null,K=null,J=null,le=null,ce=null,Ke=null,Mt=null,Ct=null}}}const i=new e,r=new t,o=new n,a=new WeakMap,l=new WeakMap;let c={},u={},h=new WeakMap,f=[],d=null,_=!1,g=null,p=null,m=null,y=null,x=null,M=null,w=null,A=new Ce(0,0,0),S=0,R=!1,I=null,v=null,E=null,N=null,z=null;const X=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let j=!1,V=0;const Y=s.getParameter(s.VERSION);Y.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(Y)[1]),j=V>=1):Y.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),j=V>=2);let W=null,se={};const L=s.getParameter(s.SCISSOR_BOX),ae=s.getParameter(s.VIEWPORT),ke=new dt().fromArray(L),Ye=new dt().fromArray(ae);function q(U,ee,K,J){const le=new Uint8Array(4),ce=s.createTexture();s.bindTexture(U,ce),s.texParameteri(U,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(U,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Ke=0;Ke<K;Ke++)U===s.TEXTURE_3D||U===s.TEXTURE_2D_ARRAY?s.texImage3D(ee,0,s.RGBA,1,1,J,0,s.RGBA,s.UNSIGNED_BYTE,le):s.texImage2D(ee+Ke,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,le);return ce}const Q={};Q[s.TEXTURE_2D]=q(s.TEXTURE_2D,s.TEXTURE_2D,1),Q[s.TEXTURE_CUBE_MAP]=q(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[s.TEXTURE_2D_ARRAY]=q(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Q[s.TEXTURE_3D]=q(s.TEXTURE_3D,s.TEXTURE_3D,1,1),i.setClear(0,0,0,1),r.setClear(1),o.setClear(0),fe(s.DEPTH_TEST),r.setFunc(oo),Fe(!1),ze(jf),fe(s.CULL_FACE),D(rr);function fe(U){c[U]!==!0&&(s.enable(U),c[U]=!0)}function oe(U){c[U]!==!1&&(s.disable(U),c[U]=!1)}function Ae(U,ee){return u[U]!==ee?(s.bindFramebuffer(U,ee),u[U]=ee,U===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=ee),U===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=ee),!0):!1}function Se(U,ee){let K=f,J=!1;if(U){K=h.get(ee),K===void 0&&(K=[],h.set(ee,K));const le=U.textures;if(K.length!==le.length||K[0]!==s.COLOR_ATTACHMENT0){for(let ce=0,Ke=le.length;ce<Ke;ce++)K[ce]=s.COLOR_ATTACHMENT0+ce;K.length=le.length,J=!0}}else K[0]!==s.BACK&&(K[0]=s.BACK,J=!0);J&&s.drawBuffers(K)}function We(U){return d!==U?(s.useProgram(U),d=U,!0):!1}const Ge={[Qr]:s.FUNC_ADD,[Fg]:s.FUNC_SUBTRACT,[Bg]:s.FUNC_REVERSE_SUBTRACT};Ge[kg]=s.MIN,Ge[zg]=s.MAX;const Oe={[Hg]:s.ZERO,[Vg]:s.ONE,[Gg]:s.SRC_COLOR,[Cu]:s.SRC_ALPHA,[jg]:s.SRC_ALPHA_SATURATE,[qg]:s.DST_COLOR,[Xg]:s.DST_ALPHA,[Wg]:s.ONE_MINUS_SRC_COLOR,[Pu]:s.ONE_MINUS_SRC_ALPHA,[Kg]:s.ONE_MINUS_DST_COLOR,[Yg]:s.ONE_MINUS_DST_ALPHA,[$g]:s.CONSTANT_COLOR,[Zg]:s.ONE_MINUS_CONSTANT_COLOR,[Jg]:s.CONSTANT_ALPHA,[Qg]:s.ONE_MINUS_CONSTANT_ALPHA};function D(U,ee,K,J,le,ce,Ke,Mt,Ct,rt){if(U===rr){_===!0&&(oe(s.BLEND),_=!1);return}if(_===!1&&(fe(s.BLEND),_=!0),U!==Og){if(U!==g||rt!==R){if((p!==Qr||x!==Qr)&&(s.blendEquation(s.FUNC_ADD),p=Qr,x=Qr),rt)switch(U){case Ks:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case _a:s.blendFunc(s.ONE,s.ONE);break;case $f:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Zf:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Ks:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case _a:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case $f:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Zf:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}m=null,y=null,M=null,w=null,A.set(0,0,0),S=0,g=U,R=rt}return}le=le||ee,ce=ce||K,Ke=Ke||J,(ee!==p||le!==x)&&(s.blendEquationSeparate(Ge[ee],Ge[le]),p=ee,x=le),(K!==m||J!==y||ce!==M||Ke!==w)&&(s.blendFuncSeparate(Oe[K],Oe[J],Oe[ce],Oe[Ke]),m=K,y=J,M=ce,w=Ke),(Mt.equals(A)===!1||Ct!==S)&&(s.blendColor(Mt.r,Mt.g,Mt.b,Ct),A.copy(Mt),S=Ct),g=U,R=!1}function at(U,ee){U.side===Mi?oe(s.CULL_FACE):fe(s.CULL_FACE);let K=U.side===On;ee&&(K=!K),Fe(K),U.blending===Ks&&U.transparent===!1?D(rr):D(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),r.setFunc(U.depthFunc),r.setTest(U.depthTest),r.setMask(U.depthWrite),i.setMask(U.colorWrite);const J=U.stencilWrite;o.setTest(J),J&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Je(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?fe(s.SAMPLE_ALPHA_TO_COVERAGE):oe(s.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(U){I!==U&&(U?s.frontFace(s.CW):s.frontFace(s.CCW),I=U)}function ze(U){U!==Ig?(fe(s.CULL_FACE),U!==v&&(U===jf?s.cullFace(s.BACK):U===Ng?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):oe(s.CULL_FACE),v=U}function B(U){U!==E&&(j&&s.lineWidth(U),E=U)}function Je(U,ee,K){U?(fe(s.POLYGON_OFFSET_FILL),(N!==ee||z!==K)&&(s.polygonOffset(ee,K),N=ee,z=K)):oe(s.POLYGON_OFFSET_FILL)}function De(U){U?fe(s.SCISSOR_TEST):oe(s.SCISSOR_TEST)}function C(U){U===void 0&&(U=s.TEXTURE0+X-1),W!==U&&(s.activeTexture(U),W=U)}function T(U,ee,K){K===void 0&&(W===null?K=s.TEXTURE0+X-1:K=W);let J=se[K];J===void 0&&(J={type:void 0,texture:void 0},se[K]=J),(J.type!==U||J.texture!==ee)&&(W!==K&&(s.activeTexture(K),W=K),s.bindTexture(U,ee||Q[U]),J.type=U,J.texture=ee)}function G(){const U=se[W];U!==void 0&&U.type!==void 0&&(s.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Z(){try{s.compressedTexImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function te(){try{s.compressedTexImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function $(){try{s.texSubImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ye(){try{s.texSubImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ie(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function de(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ve(){try{s.texStorage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ne(){try{s.texStorage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ve(){try{s.texImage2D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function xe(){try{s.texImage3D.apply(s,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ne(U){ke.equals(U)===!1&&(s.scissor(U.x,U.y,U.z,U.w),ke.copy(U))}function ge(U){Ye.equals(U)===!1&&(s.viewport(U.x,U.y,U.z,U.w),Ye.copy(U))}function qe(U,ee){let K=l.get(ee);K===void 0&&(K=new WeakMap,l.set(ee,K));let J=K.get(U);J===void 0&&(J=s.getUniformBlockIndex(ee,U.name),K.set(U,J))}function Be(U,ee){const J=l.get(ee).get(U);a.get(ee)!==J&&(s.uniformBlockBinding(ee,J,U.__bindingPointIndex),a.set(ee,J))}function lt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),c={},W=null,se={},u={},h=new WeakMap,f=[],d=null,_=!1,g=null,p=null,m=null,y=null,x=null,M=null,w=null,A=new Ce(0,0,0),S=0,R=!1,I=null,v=null,E=null,N=null,z=null,ke.set(0,0,s.canvas.width,s.canvas.height),Ye.set(0,0,s.canvas.width,s.canvas.height),i.reset(),r.reset(),o.reset()}return{buffers:{color:i,depth:r,stencil:o},enable:fe,disable:oe,bindFramebuffer:Ae,drawBuffers:Se,useProgram:We,setBlending:D,setMaterial:at,setFlipSided:Fe,setCullFace:ze,setLineWidth:B,setPolygonOffset:Je,setScissorTest:De,activeTexture:C,bindTexture:T,unbindTexture:G,compressedTexImage2D:Z,compressedTexImage3D:te,texImage2D:ve,texImage3D:xe,updateUBOMapping:qe,uniformBlockBinding:Be,texStorage2D:Ve,texStorage3D:ne,texSubImage2D:$,texSubImage3D:ye,compressedTexSubImage2D:ie,compressedTexSubImage3D:de,scissor:Ne,viewport:ge,reset:lt}}function Xd(s,e,t,n){const i=DS(n);switch(t){case ym:return s*e;case Sm:return s*e;case Tm:return s*e*2;case jh:return s*e/i.components*i.byteLength;case $h:return s*e/i.components*i.byteLength;case Em:return s*e*2/i.components*i.byteLength;case Zh:return s*e*2/i.components*i.byteLength;case Mm:return s*e*3/i.components*i.byteLength;case hi:return s*e*4/i.components*i.byteLength;case Jh:return s*e*4/i.components*i.byteLength;case Pl:case Ll:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case Dl:case Il:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case Hu:case Gu:return Math.max(s,16)*Math.max(e,8)/4;case zu:case Vu:return Math.max(s,8)*Math.max(e,8)/2;case Wu:case Xu:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case Yu:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case qu:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case Ku:return Math.floor((s+4)/5)*Math.floor((e+3)/4)*16;case ju:return Math.floor((s+4)/5)*Math.floor((e+4)/5)*16;case $u:return Math.floor((s+5)/6)*Math.floor((e+4)/5)*16;case Zu:return Math.floor((s+5)/6)*Math.floor((e+5)/6)*16;case Ju:return Math.floor((s+7)/8)*Math.floor((e+4)/5)*16;case Qu:return Math.floor((s+7)/8)*Math.floor((e+5)/6)*16;case eh:return Math.floor((s+7)/8)*Math.floor((e+7)/8)*16;case th:return Math.floor((s+9)/10)*Math.floor((e+4)/5)*16;case nh:return Math.floor((s+9)/10)*Math.floor((e+5)/6)*16;case ih:return Math.floor((s+9)/10)*Math.floor((e+7)/8)*16;case rh:return Math.floor((s+9)/10)*Math.floor((e+9)/10)*16;case sh:return Math.floor((s+11)/12)*Math.floor((e+9)/10)*16;case oh:return Math.floor((s+11)/12)*Math.floor((e+11)/12)*16;case Nl:case ah:case lh:return Math.ceil(s/4)*Math.ceil(e/4)*16;case bm:case ch:return Math.ceil(s/4)*Math.ceil(e/4)*8;case uh:case hh:return Math.ceil(s/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function DS(s){switch(s){case lr:case gm:return{byteLength:1,components:1};case ga:case vm:case sr:return{byteLength:2,components:1};case qh:case Kh:return{byteLength:2,components:4};case ds:case Yh:case Ti:return{byteLength:4,components:1};case xm:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${s}.`)}function IS(s,e,t,n,i,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Te,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(C,T){return d?new OffscreenCanvas(C,T):ya("canvas")}function g(C,T,G){let Z=1;const te=De(C);if((te.width>G||te.height>G)&&(Z=G/Math.max(te.width,te.height)),Z<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const $=Math.floor(Z*te.width),ye=Math.floor(Z*te.height);h===void 0&&(h=_($,ye));const ie=T?_($,ye):h;return ie.width=$,ie.height=ye,ie.getContext("2d").drawImage(C,0,0,$,ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+$+"x"+ye+")."),ie}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),C;return C}function p(C){return C.generateMipmaps&&C.minFilter!==In&&C.minFilter!==$n}function m(C){s.generateMipmap(C)}function y(C,T,G,Z,te=!1){if(C!==null){if(s[C]!==void 0)return s[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let $=T;if(T===s.RED&&(G===s.FLOAT&&($=s.R32F),G===s.HALF_FLOAT&&($=s.R16F),G===s.UNSIGNED_BYTE&&($=s.R8)),T===s.RED_INTEGER&&(G===s.UNSIGNED_BYTE&&($=s.R8UI),G===s.UNSIGNED_SHORT&&($=s.R16UI),G===s.UNSIGNED_INT&&($=s.R32UI),G===s.BYTE&&($=s.R8I),G===s.SHORT&&($=s.R16I),G===s.INT&&($=s.R32I)),T===s.RG&&(G===s.FLOAT&&($=s.RG32F),G===s.HALF_FLOAT&&($=s.RG16F),G===s.UNSIGNED_BYTE&&($=s.RG8)),T===s.RG_INTEGER&&(G===s.UNSIGNED_BYTE&&($=s.RG8UI),G===s.UNSIGNED_SHORT&&($=s.RG16UI),G===s.UNSIGNED_INT&&($=s.RG32UI),G===s.BYTE&&($=s.RG8I),G===s.SHORT&&($=s.RG16I),G===s.INT&&($=s.RG32I)),T===s.RGB_INTEGER&&(G===s.UNSIGNED_BYTE&&($=s.RGB8UI),G===s.UNSIGNED_SHORT&&($=s.RGB16UI),G===s.UNSIGNED_INT&&($=s.RGB32UI),G===s.BYTE&&($=s.RGB8I),G===s.SHORT&&($=s.RGB16I),G===s.INT&&($=s.RGB32I)),T===s.RGBA_INTEGER&&(G===s.UNSIGNED_BYTE&&($=s.RGBA8UI),G===s.UNSIGNED_SHORT&&($=s.RGBA16UI),G===s.UNSIGNED_INT&&($=s.RGBA32UI),G===s.BYTE&&($=s.RGBA8I),G===s.SHORT&&($=s.RGBA16I),G===s.INT&&($=s.RGBA32I)),T===s.RGB&&G===s.UNSIGNED_INT_5_9_9_9_REV&&($=s.RGB9_E5),T===s.RGBA){const ye=te?ql:ft.getTransfer(Z);G===s.FLOAT&&($=s.RGBA32F),G===s.HALF_FLOAT&&($=s.RGBA16F),G===s.UNSIGNED_BYTE&&($=ye===bt?s.SRGB8_ALPHA8:s.RGBA8),G===s.UNSIGNED_SHORT_4_4_4_4&&($=s.RGBA4),G===s.UNSIGNED_SHORT_5_5_5_1&&($=s.RGB5_A1)}return($===s.R16F||$===s.R32F||$===s.RG16F||$===s.RG32F||$===s.RGBA16F||$===s.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function x(C,T){let G;return C?T===null||T===ds||T===uo?G=s.DEPTH24_STENCIL8:T===Ti?G=s.DEPTH32F_STENCIL8:T===ga&&(G=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===ds||T===uo?G=s.DEPTH_COMPONENT24:T===Ti?G=s.DEPTH_COMPONENT32F:T===ga&&(G=s.DEPTH_COMPONENT16),G}function M(C,T){return p(C)===!0||C.isFramebufferTexture&&C.minFilter!==In&&C.minFilter!==$n?Math.log2(Math.max(T.width,T.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?T.mipmaps.length:1}function w(C){const T=C.target;T.removeEventListener("dispose",w),S(T),T.isVideoTexture&&u.delete(T)}function A(C){const T=C.target;T.removeEventListener("dispose",A),I(T)}function S(C){const T=n.get(C);if(T.__webglInit===void 0)return;const G=C.source,Z=f.get(G);if(Z){const te=Z[T.__cacheKey];te.usedTimes--,te.usedTimes===0&&R(C),Object.keys(Z).length===0&&f.delete(G)}n.remove(C)}function R(C){const T=n.get(C);s.deleteTexture(T.__webglTexture);const G=C.source,Z=f.get(G);delete Z[T.__cacheKey],o.memory.textures--}function I(C){const T=n.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(T.__webglFramebuffer[Z]))for(let te=0;te<T.__webglFramebuffer[Z].length;te++)s.deleteFramebuffer(T.__webglFramebuffer[Z][te]);else s.deleteFramebuffer(T.__webglFramebuffer[Z]);T.__webglDepthbuffer&&s.deleteRenderbuffer(T.__webglDepthbuffer[Z])}else{if(Array.isArray(T.__webglFramebuffer))for(let Z=0;Z<T.__webglFramebuffer.length;Z++)s.deleteFramebuffer(T.__webglFramebuffer[Z]);else s.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&s.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&s.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let Z=0;Z<T.__webglColorRenderbuffer.length;Z++)T.__webglColorRenderbuffer[Z]&&s.deleteRenderbuffer(T.__webglColorRenderbuffer[Z]);T.__webglDepthRenderbuffer&&s.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const G=C.textures;for(let Z=0,te=G.length;Z<te;Z++){const $=n.get(G[Z]);$.__webglTexture&&(s.deleteTexture($.__webglTexture),o.memory.textures--),n.remove(G[Z])}n.remove(C)}let v=0;function E(){v=0}function N(){const C=v;return C>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+i.maxTextures),v+=1,C}function z(C){const T=[];return T.push(C.wrapS),T.push(C.wrapT),T.push(C.wrapR||0),T.push(C.magFilter),T.push(C.minFilter),T.push(C.anisotropy),T.push(C.internalFormat),T.push(C.format),T.push(C.type),T.push(C.generateMipmaps),T.push(C.premultiplyAlpha),T.push(C.flipY),T.push(C.unpackAlignment),T.push(C.colorSpace),T.join()}function X(C,T){const G=n.get(C);if(C.isVideoTexture&&B(C),C.isRenderTargetTexture===!1&&C.version>0&&G.__version!==C.version){const Z=C.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ye(G,C,T);return}}t.bindTexture(s.TEXTURE_2D,G.__webglTexture,s.TEXTURE0+T)}function j(C,T){const G=n.get(C);if(C.version>0&&G.__version!==C.version){Ye(G,C,T);return}t.bindTexture(s.TEXTURE_2D_ARRAY,G.__webglTexture,s.TEXTURE0+T)}function V(C,T){const G=n.get(C);if(C.version>0&&G.__version!==C.version){Ye(G,C,T);return}t.bindTexture(s.TEXTURE_3D,G.__webglTexture,s.TEXTURE0+T)}function Y(C,T){const G=n.get(C);if(C.version>0&&G.__version!==C.version){q(G,C,T);return}t.bindTexture(s.TEXTURE_CUBE_MAP,G.__webglTexture,s.TEXTURE0+T)}const W={[co]:s.REPEAT,[Sr]:s.CLAMP_TO_EDGE,[Yl]:s.MIRRORED_REPEAT},se={[In]:s.NEAREST,[_m]:s.NEAREST_MIPMAP_NEAREST,[Yo]:s.NEAREST_MIPMAP_LINEAR,[$n]:s.LINEAR,[Cl]:s.LINEAR_MIPMAP_NEAREST,[tr]:s.LINEAR_MIPMAP_LINEAR},L={[c0]:s.NEVER,[m0]:s.ALWAYS,[u0]:s.LESS,[Rm]:s.LEQUAL,[h0]:s.EQUAL,[p0]:s.GEQUAL,[f0]:s.GREATER,[d0]:s.NOTEQUAL};function ae(C,T){if(T.type===Ti&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===$n||T.magFilter===Cl||T.magFilter===Yo||T.magFilter===tr||T.minFilter===$n||T.minFilter===Cl||T.minFilter===Yo||T.minFilter===tr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(C,s.TEXTURE_WRAP_S,W[T.wrapS]),s.texParameteri(C,s.TEXTURE_WRAP_T,W[T.wrapT]),(C===s.TEXTURE_3D||C===s.TEXTURE_2D_ARRAY)&&s.texParameteri(C,s.TEXTURE_WRAP_R,W[T.wrapR]),s.texParameteri(C,s.TEXTURE_MAG_FILTER,se[T.magFilter]),s.texParameteri(C,s.TEXTURE_MIN_FILTER,se[T.minFilter]),T.compareFunction&&(s.texParameteri(C,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(C,s.TEXTURE_COMPARE_FUNC,L[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===In||T.minFilter!==Yo&&T.minFilter!==tr||T.type===Ti&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||n.get(T).__currentAnisotropy){const G=e.get("EXT_texture_filter_anisotropic");s.texParameterf(C,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,i.getMaxAnisotropy())),n.get(T).__currentAnisotropy=T.anisotropy}}}function ke(C,T){let G=!1;C.__webglInit===void 0&&(C.__webglInit=!0,T.addEventListener("dispose",w));const Z=T.source;let te=f.get(Z);te===void 0&&(te={},f.set(Z,te));const $=z(T);if($!==C.__cacheKey){te[$]===void 0&&(te[$]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,G=!0),te[$].usedTimes++;const ye=te[C.__cacheKey];ye!==void 0&&(te[C.__cacheKey].usedTimes--,ye.usedTimes===0&&R(T)),C.__cacheKey=$,C.__webglTexture=te[$].texture}return G}function Ye(C,T,G){let Z=s.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(Z=s.TEXTURE_2D_ARRAY),T.isData3DTexture&&(Z=s.TEXTURE_3D);const te=ke(C,T),$=T.source;t.bindTexture(Z,C.__webglTexture,s.TEXTURE0+G);const ye=n.get($);if($.version!==ye.__version||te===!0){t.activeTexture(s.TEXTURE0+G);const ie=ft.getPrimaries(ft.workingColorSpace),de=T.colorSpace===Mr?null:ft.getPrimaries(T.colorSpace),Ve=T.colorSpace===Mr||ie===de?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,T.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,T.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);let ne=g(T.image,!1,i.maxTextureSize);ne=Je(T,ne);const ve=r.convert(T.format,T.colorSpace),xe=r.convert(T.type);let Ne=y(T.internalFormat,ve,xe,T.colorSpace,T.isVideoTexture);ae(Z,T);let ge;const qe=T.mipmaps,Be=T.isVideoTexture!==!0,lt=ye.__version===void 0||te===!0,U=$.dataReady,ee=M(T,ne);if(T.isDepthTexture)Ne=x(T.format===ho,T.type),lt&&(Be?t.texStorage2D(s.TEXTURE_2D,1,Ne,ne.width,ne.height):t.texImage2D(s.TEXTURE_2D,0,Ne,ne.width,ne.height,0,ve,xe,null));else if(T.isDataTexture)if(qe.length>0){Be&&lt&&t.texStorage2D(s.TEXTURE_2D,ee,Ne,qe[0].width,qe[0].height);for(let K=0,J=qe.length;K<J;K++)ge=qe[K],Be?U&&t.texSubImage2D(s.TEXTURE_2D,K,0,0,ge.width,ge.height,ve,xe,ge.data):t.texImage2D(s.TEXTURE_2D,K,Ne,ge.width,ge.height,0,ve,xe,ge.data);T.generateMipmaps=!1}else Be?(lt&&t.texStorage2D(s.TEXTURE_2D,ee,Ne,ne.width,ne.height),U&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ne.width,ne.height,ve,xe,ne.data)):t.texImage2D(s.TEXTURE_2D,0,Ne,ne.width,ne.height,0,ve,xe,ne.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){Be&&lt&&t.texStorage3D(s.TEXTURE_2D_ARRAY,ee,Ne,qe[0].width,qe[0].height,ne.depth);for(let K=0,J=qe.length;K<J;K++)if(ge=qe[K],T.format!==hi)if(ve!==null)if(Be){if(U)if(T.layerUpdates.size>0){const le=Xd(ge.width,ge.height,T.format,T.type);for(const ce of T.layerUpdates){const Ke=ge.data.subarray(ce*le/ge.data.BYTES_PER_ELEMENT,(ce+1)*le/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,K,0,0,ce,ge.width,ge.height,1,ve,Ke,0,0)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,K,0,0,0,ge.width,ge.height,ne.depth,ve,ge.data,0,0)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,K,Ne,ge.width,ge.height,ne.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Be?U&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,K,0,0,0,ge.width,ge.height,ne.depth,ve,xe,ge.data):t.texImage3D(s.TEXTURE_2D_ARRAY,K,Ne,ge.width,ge.height,ne.depth,0,ve,xe,ge.data)}else{Be&&lt&&t.texStorage2D(s.TEXTURE_2D,ee,Ne,qe[0].width,qe[0].height);for(let K=0,J=qe.length;K<J;K++)ge=qe[K],T.format!==hi?ve!==null?Be?U&&t.compressedTexSubImage2D(s.TEXTURE_2D,K,0,0,ge.width,ge.height,ve,ge.data):t.compressedTexImage2D(s.TEXTURE_2D,K,Ne,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Be?U&&t.texSubImage2D(s.TEXTURE_2D,K,0,0,ge.width,ge.height,ve,xe,ge.data):t.texImage2D(s.TEXTURE_2D,K,Ne,ge.width,ge.height,0,ve,xe,ge.data)}else if(T.isDataArrayTexture)if(Be){if(lt&&t.texStorage3D(s.TEXTURE_2D_ARRAY,ee,Ne,ne.width,ne.height,ne.depth),U)if(T.layerUpdates.size>0){const K=Xd(ne.width,ne.height,T.format,T.type);for(const J of T.layerUpdates){const le=ne.data.subarray(J*K/ne.data.BYTES_PER_ELEMENT,(J+1)*K/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,J,ne.width,ne.height,1,ve,xe,le)}T.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,ve,xe,ne.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,Ne,ne.width,ne.height,ne.depth,0,ve,xe,ne.data);else if(T.isData3DTexture)Be?(lt&&t.texStorage3D(s.TEXTURE_3D,ee,Ne,ne.width,ne.height,ne.depth),U&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,ve,xe,ne.data)):t.texImage3D(s.TEXTURE_3D,0,Ne,ne.width,ne.height,ne.depth,0,ve,xe,ne.data);else if(T.isFramebufferTexture){if(lt)if(Be)t.texStorage2D(s.TEXTURE_2D,ee,Ne,ne.width,ne.height);else{let K=ne.width,J=ne.height;for(let le=0;le<ee;le++)t.texImage2D(s.TEXTURE_2D,le,Ne,K,J,0,ve,xe,null),K>>=1,J>>=1}}else if(qe.length>0){if(Be&&lt){const K=De(qe[0]);t.texStorage2D(s.TEXTURE_2D,ee,Ne,K.width,K.height)}for(let K=0,J=qe.length;K<J;K++)ge=qe[K],Be?U&&t.texSubImage2D(s.TEXTURE_2D,K,0,0,ve,xe,ge):t.texImage2D(s.TEXTURE_2D,K,Ne,ve,xe,ge);T.generateMipmaps=!1}else if(Be){if(lt){const K=De(ne);t.texStorage2D(s.TEXTURE_2D,ee,Ne,K.width,K.height)}U&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ve,xe,ne)}else t.texImage2D(s.TEXTURE_2D,0,Ne,ve,xe,ne);p(T)&&m(Z),ye.__version=$.version,T.onUpdate&&T.onUpdate(T)}C.__version=T.version}function q(C,T,G){if(T.image.length!==6)return;const Z=ke(C,T),te=T.source;t.bindTexture(s.TEXTURE_CUBE_MAP,C.__webglTexture,s.TEXTURE0+G);const $=n.get(te);if(te.version!==$.__version||Z===!0){t.activeTexture(s.TEXTURE0+G);const ye=ft.getPrimaries(ft.workingColorSpace),ie=T.colorSpace===Mr?null:ft.getPrimaries(T.colorSpace),de=T.colorSpace===Mr||ye===ie?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,T.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,T.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Ve=T.isCompressedTexture||T.image[0].isCompressedTexture,ne=T.image[0]&&T.image[0].isDataTexture,ve=[];for(let J=0;J<6;J++)!Ve&&!ne?ve[J]=g(T.image[J],!0,i.maxCubemapSize):ve[J]=ne?T.image[J].image:T.image[J],ve[J]=Je(T,ve[J]);const xe=ve[0],Ne=r.convert(T.format,T.colorSpace),ge=r.convert(T.type),qe=y(T.internalFormat,Ne,ge,T.colorSpace),Be=T.isVideoTexture!==!0,lt=$.__version===void 0||Z===!0,U=te.dataReady;let ee=M(T,xe);ae(s.TEXTURE_CUBE_MAP,T);let K;if(Ve){Be&&lt&&t.texStorage2D(s.TEXTURE_CUBE_MAP,ee,qe,xe.width,xe.height);for(let J=0;J<6;J++){K=ve[J].mipmaps;for(let le=0;le<K.length;le++){const ce=K[le];T.format!==hi?Ne!==null?Be?U&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,0,0,ce.width,ce.height,Ne,ce.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,qe,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Be?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,0,0,ce.width,ce.height,Ne,ge,ce.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,qe,ce.width,ce.height,0,Ne,ge,ce.data)}}}else{if(K=T.mipmaps,Be&&lt){K.length>0&&ee++;const J=De(ve[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,ee,qe,J.width,J.height)}for(let J=0;J<6;J++)if(ne){Be?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ve[J].width,ve[J].height,Ne,ge,ve[J].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,qe,ve[J].width,ve[J].height,0,Ne,ge,ve[J].data);for(let le=0;le<K.length;le++){const Ke=K[le].image[J].image;Be?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,0,0,Ke.width,Ke.height,Ne,ge,Ke.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,qe,Ke.width,Ke.height,0,Ne,ge,Ke.data)}}else{Be?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ne,ge,ve[J]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,qe,Ne,ge,ve[J]);for(let le=0;le<K.length;le++){const ce=K[le];Be?U&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,0,0,Ne,ge,ce.image[J]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,qe,Ne,ge,ce.image[J])}}}p(T)&&m(s.TEXTURE_CUBE_MAP),$.__version=te.version,T.onUpdate&&T.onUpdate(T)}C.__version=T.version}function Q(C,T,G,Z,te,$){const ye=r.convert(G.format,G.colorSpace),ie=r.convert(G.type),de=y(G.internalFormat,ye,ie,G.colorSpace);if(!n.get(T).__hasExternalTextures){const ne=Math.max(1,T.width>>$),ve=Math.max(1,T.height>>$);te===s.TEXTURE_3D||te===s.TEXTURE_2D_ARRAY?t.texImage3D(te,$,de,ne,ve,T.depth,0,ye,ie,null):t.texImage2D(te,$,de,ne,ve,0,ye,ie,null)}t.bindFramebuffer(s.FRAMEBUFFER,C),ze(T)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Z,te,n.get(G).__webglTexture,0,Fe(T)):(te===s.TEXTURE_2D||te>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Z,te,n.get(G).__webglTexture,$),t.bindFramebuffer(s.FRAMEBUFFER,null)}function fe(C,T,G){if(s.bindRenderbuffer(s.RENDERBUFFER,C),T.depthBuffer){const Z=T.depthTexture,te=Z&&Z.isDepthTexture?Z.type:null,$=x(T.stencilBuffer,te),ye=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ie=Fe(T);ze(T)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ie,$,T.width,T.height):G?s.renderbufferStorageMultisample(s.RENDERBUFFER,ie,$,T.width,T.height):s.renderbufferStorage(s.RENDERBUFFER,$,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,ye,s.RENDERBUFFER,C)}else{const Z=T.textures;for(let te=0;te<Z.length;te++){const $=Z[te],ye=r.convert($.format,$.colorSpace),ie=r.convert($.type),de=y($.internalFormat,ye,ie,$.colorSpace),Ve=Fe(T);G&&ze(T)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ve,de,T.width,T.height):ze(T)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ve,de,T.width,T.height):s.renderbufferStorage(s.RENDERBUFFER,de,T.width,T.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function oe(C,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,C),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(T.depthTexture).__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),X(T.depthTexture,0);const Z=n.get(T.depthTexture).__webglTexture,te=Fe(T);if(T.depthTexture.format===js)ze(T)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0,te):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0);else if(T.depthTexture.format===ho)ze(T)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0,te):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Ae(C){const T=n.get(C),G=C.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==C.depthTexture){const Z=C.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),Z){const te=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,Z.removeEventListener("dispose",te)};Z.addEventListener("dispose",te),T.__depthDisposeCallback=te}T.__boundDepthTexture=Z}if(C.depthTexture&&!T.__autoAllocateDepthBuffer){if(G)throw new Error("target.depthTexture not supported in Cube render targets");oe(T.__webglFramebuffer,C)}else if(G){T.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(t.bindFramebuffer(s.FRAMEBUFFER,T.__webglFramebuffer[Z]),T.__webglDepthbuffer[Z]===void 0)T.__webglDepthbuffer[Z]=s.createRenderbuffer(),fe(T.__webglDepthbuffer[Z],C,!1);else{const te=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,$=T.__webglDepthbuffer[Z];s.bindRenderbuffer(s.RENDERBUFFER,$),s.framebufferRenderbuffer(s.FRAMEBUFFER,te,s.RENDERBUFFER,$)}}else if(t.bindFramebuffer(s.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=s.createRenderbuffer(),fe(T.__webglDepthbuffer,C,!1);else{const Z=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,te=T.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,te),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,te)}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Se(C,T,G){const Z=n.get(C);T!==void 0&&Q(Z.__webglFramebuffer,C,C.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),G!==void 0&&Ae(C)}function We(C){const T=C.texture,G=n.get(C),Z=n.get(T);C.addEventListener("dispose",A);const te=C.textures,$=C.isWebGLCubeRenderTarget===!0,ye=te.length>1;if(ye||(Z.__webglTexture===void 0&&(Z.__webglTexture=s.createTexture()),Z.__version=T.version,o.memory.textures++),$){G.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(T.mipmaps&&T.mipmaps.length>0){G.__webglFramebuffer[ie]=[];for(let de=0;de<T.mipmaps.length;de++)G.__webglFramebuffer[ie][de]=s.createFramebuffer()}else G.__webglFramebuffer[ie]=s.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){G.__webglFramebuffer=[];for(let ie=0;ie<T.mipmaps.length;ie++)G.__webglFramebuffer[ie]=s.createFramebuffer()}else G.__webglFramebuffer=s.createFramebuffer();if(ye)for(let ie=0,de=te.length;ie<de;ie++){const Ve=n.get(te[ie]);Ve.__webglTexture===void 0&&(Ve.__webglTexture=s.createTexture(),o.memory.textures++)}if(C.samples>0&&ze(C)===!1){G.__webglMultisampledFramebuffer=s.createFramebuffer(),G.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let ie=0;ie<te.length;ie++){const de=te[ie];G.__webglColorRenderbuffer[ie]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,G.__webglColorRenderbuffer[ie]);const Ve=r.convert(de.format,de.colorSpace),ne=r.convert(de.type),ve=y(de.internalFormat,Ve,ne,de.colorSpace,C.isXRRenderTarget===!0),xe=Fe(C);s.renderbufferStorageMultisample(s.RENDERBUFFER,xe,ve,C.width,C.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ie,s.RENDERBUFFER,G.__webglColorRenderbuffer[ie])}s.bindRenderbuffer(s.RENDERBUFFER,null),C.depthBuffer&&(G.__webglDepthRenderbuffer=s.createRenderbuffer(),fe(G.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if($){t.bindTexture(s.TEXTURE_CUBE_MAP,Z.__webglTexture),ae(s.TEXTURE_CUBE_MAP,T);for(let ie=0;ie<6;ie++)if(T.mipmaps&&T.mipmaps.length>0)for(let de=0;de<T.mipmaps.length;de++)Q(G.__webglFramebuffer[ie][de],C,T,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ie,de);else Q(G.__webglFramebuffer[ie],C,T,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);p(T)&&m(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ye){for(let ie=0,de=te.length;ie<de;ie++){const Ve=te[ie],ne=n.get(Ve);t.bindTexture(s.TEXTURE_2D,ne.__webglTexture),ae(s.TEXTURE_2D,Ve),Q(G.__webglFramebuffer,C,Ve,s.COLOR_ATTACHMENT0+ie,s.TEXTURE_2D,0),p(Ve)&&m(s.TEXTURE_2D)}t.unbindTexture()}else{let ie=s.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ie=C.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(ie,Z.__webglTexture),ae(ie,T),T.mipmaps&&T.mipmaps.length>0)for(let de=0;de<T.mipmaps.length;de++)Q(G.__webglFramebuffer[de],C,T,s.COLOR_ATTACHMENT0,ie,de);else Q(G.__webglFramebuffer,C,T,s.COLOR_ATTACHMENT0,ie,0);p(T)&&m(ie),t.unbindTexture()}C.depthBuffer&&Ae(C)}function Ge(C){const T=C.textures;for(let G=0,Z=T.length;G<Z;G++){const te=T[G];if(p(te)){const $=C.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:s.TEXTURE_2D,ye=n.get(te).__webglTexture;t.bindTexture($,ye),m($),t.unbindTexture()}}}const Oe=[],D=[];function at(C){if(C.samples>0){if(ze(C)===!1){const T=C.textures,G=C.width,Z=C.height;let te=s.COLOR_BUFFER_BIT;const $=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ye=n.get(C),ie=T.length>1;if(ie)for(let de=0;de<T.length;de++)t.bindFramebuffer(s.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,ye.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let de=0;de<T.length;de++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(te|=s.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(te|=s.STENCIL_BUFFER_BIT)),ie){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,ye.__webglColorRenderbuffer[de]);const Ve=n.get(T[de]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Ve,0)}s.blitFramebuffer(0,0,G,Z,0,0,G,Z,te,s.NEAREST),l===!0&&(Oe.length=0,D.length=0,Oe.push(s.COLOR_ATTACHMENT0+de),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Oe.push($),D.push($),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,D)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Oe))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),ie)for(let de=0;de<T.length;de++){t.bindFramebuffer(s.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.RENDERBUFFER,ye.__webglColorRenderbuffer[de]);const Ve=n.get(T[de]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,ye.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+de,s.TEXTURE_2D,Ve,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const T=C.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[T])}}}function Fe(C){return Math.min(i.maxSamples,C.samples)}function ze(C){const T=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function B(C){const T=o.render.frame;u.get(C)!==T&&(u.set(C,T),C.update())}function Je(C,T){const G=C.colorSpace,Z=C.format,te=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||G!==pn&&G!==Mr&&(ft.getTransfer(G)===bt?(Z!==hi||te!==lr)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",G)),T}function De(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=N,this.resetTextureUnits=E,this.setTexture2D=X,this.setTexture2DArray=j,this.setTexture3D=V,this.setTextureCube=Y,this.rebindTextures=Se,this.setupRenderTarget=We,this.updateRenderTargetMipmap=Ge,this.updateMultisampleRenderTarget=at,this.setupDepthRenderbuffer=Ae,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=ze}function NS(s,e){function t(n,i=Mr){let r;const o=ft.getTransfer(i);if(n===lr)return s.UNSIGNED_BYTE;if(n===qh)return s.UNSIGNED_SHORT_4_4_4_4;if(n===Kh)return s.UNSIGNED_SHORT_5_5_5_1;if(n===xm)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===gm)return s.BYTE;if(n===vm)return s.SHORT;if(n===ga)return s.UNSIGNED_SHORT;if(n===Yh)return s.INT;if(n===ds)return s.UNSIGNED_INT;if(n===Ti)return s.FLOAT;if(n===sr)return s.HALF_FLOAT;if(n===ym)return s.ALPHA;if(n===Mm)return s.RGB;if(n===hi)return s.RGBA;if(n===Sm)return s.LUMINANCE;if(n===Tm)return s.LUMINANCE_ALPHA;if(n===js)return s.DEPTH_COMPONENT;if(n===ho)return s.DEPTH_STENCIL;if(n===jh)return s.RED;if(n===$h)return s.RED_INTEGER;if(n===Em)return s.RG;if(n===Zh)return s.RG_INTEGER;if(n===Jh)return s.RGBA_INTEGER;if(n===Pl||n===Ll||n===Dl||n===Il)if(o===bt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Pl)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ll)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Dl)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Il)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Pl)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ll)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Dl)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Il)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===zu||n===Hu||n===Vu||n===Gu)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===zu)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Hu)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Vu)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Gu)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Wu||n===Xu||n===Yu)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Wu||n===Xu)return o===bt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Yu)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===qu||n===Ku||n===ju||n===$u||n===Zu||n===Ju||n===Qu||n===eh||n===th||n===nh||n===ih||n===rh||n===sh||n===oh)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===qu)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ku)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ju)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===$u)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Zu)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ju)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Qu)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===eh)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===th)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===nh)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ih)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===rh)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===sh)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===oh)return o===bt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Nl||n===ah||n===lh)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Nl)return o===bt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ah)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===lh)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===bm||n===ch||n===uh||n===hh)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Nl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ch)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===uh)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===hh)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===uo?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}class US extends hn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Tr extends Ot{constructor(){super(),this.isGroup=!0,this.type="Group"}}const OS={type:"move"};class eu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Tr,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Tr,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Tr,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const g of e.hand.values()){const p=t.getJointPose(g,n),m=this._getHandJoint(c,g);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],f=u.position.distanceTo(h.position),d=.02,_=.005;c.inputState.pinching&&f>d+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=d-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(OS)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Tr;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const FS=`
void main() {
